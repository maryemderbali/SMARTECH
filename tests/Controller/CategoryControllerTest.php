...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'category[nomcategorie]' => 'Testing',
            'category[descriptioncategorie]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setDescriptioncategorie('Value');
        ...
        $this->client->submitForm('Update', [
            'category[nomcategorie]' => 'Something New',
            'category[descriptioncategorie]' => 'Something New',
        ]);
